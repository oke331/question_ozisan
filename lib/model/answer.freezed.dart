...
abstract class $AnswerCopyWith<$Res> {
  ...
  $Res call({String text, OzisanType ozisanType});
}
...
class _$_Answer implements _Answer {
  const _$_Answer({required this.text, required this.ozisanType});
  ...
  @override
  String toString() {
    return 'Answer(text: $text, ozisanType: $ozisanType)';
  }
...
abstract class _Answer implements Answer {
  const factory _Answer(
      ...
      required final OzisanType ozisanType}) = _$_Answer;
